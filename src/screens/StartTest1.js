...
export default class AccelerometerSensor extends React.Component {
  ...
  _start = () =>{
    ...
    //alert(this.state.storagePermission)
    //alert(this.state.storagePermission)
    if(this.state.readStoragePermission === true && this.state.writeStoragePermission ===true){
      startSound.play()
    ...
    TimerMixin.setTimeout(() =>{
      ...
      alert('go to app settings and allow storage permission to continue')
    }
  }
  ...
  _upload = () => {
    ...
    firebase.storage()
    .ref().child(`${userName}/test1/${fileName}`)
    .putFile(pathToWrite)
    .then(uploadedFile => {
        //success
        alert('success')
  ...
  render() {
    ...
    return (
      ...
      <Text style = {styles.mainHeader}> Testing Kinetic Tremor </Text>
        ...
        <TouchableOpacity onPress={() =>this.props.navigation.navigate('ExplainTest', {userName :this.props.navigation.getParam('userName'),value : 1 })} style={styles.howToButton}>
        ...
        <View style={styles.buttonContainer}>
         ...
         <View style={styles.buttonContainer}> 
          <TouchableOpacity onPress={() =>this.props.navigation.navigate('StartTest2', {userName :this.props.navigation.getParam('userName') })} style={styles.button}>
            <Text style ={styles.buttonText}>Next Test</Text>
          </TouchableOpacity>
        </View>
        </View>
      </View>
