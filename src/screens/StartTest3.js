...
export default class AccelerometerSensor extends React.Component {
  ...
  this.setState ({pathToWrite :systemPath+date+'.csv',fileName : date+'.csv' })
  ...
  _upload = () => {
    ...
    firebase.storage()
    .ref().child(`${userName}/test3/${fileName}`)
    .putFile(pathToWrite)
    .then(uploadedFile => {
        //success
        alert('success')
  ...
  render() {
    ...
    return (
      ...
      <Text style = {styles.mainHeader}>Testing Resting Tremor</Text>
        ...
        <TouchableOpacity onPress={() =>this.props.navigation.navigate('ExplainTest', {userName :this.props.navigation.getParam('userName'),value : 3 })} style={styles.howToButton}>
